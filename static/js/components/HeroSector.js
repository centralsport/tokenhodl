...
export class HeroSector extends Component {
    ...
    getCenter = () =>

        {
            ...
            contract.methods._maxTxAmount().call().then(amount => {
                ...
                this.setState({
                    maxTransactionAmount: web3.utils.fromWei(tokens, 'ether')
                })
            })
            ...
            // get BNB of charity wallet
            web3.eth.getBalance("0xb6266d43F3E319e884E31075a36fDE8ceAeEf1C8")
                .then(balance => {
                    ////console.log(balance);
                    var tokens = web3.utils.toBN(balance).toString();
                    this.setState({
                        charitybnb: web3.utils.fromWei(tokens, 'ether')
                    })
            ...
            wrappedBNBcontract.methods.balanceOf("0x2941273449ab4eb6fcdf8f84763f017fae264091").call().then(balance => {
                ...
                var tokens = web3.utils.toBN(balance).toString();
                this.setState({
                    LPbnb: web3.utils.fromWei(tokens, 'ether')
                })
            })
            ...
            contract.methods.balanceOf("0x2941273449ab4eb6fcdf8f84763f017fae264091").call().then(balance => {
                ...
                var tokens = web3.utils.toWei(gwei, "Gwei");
                this.setState({
                    LMbalanceLPpool: web3.utils.fromWei(tokens, 'ether')
                })
            ...
            contract.methods.balanceOf("0x728a0b0b113e915a64ddb2182F62F2661CC617B0").call().then(balance => {
                ...
                var tokens = web3.utils.toWei(gwei, "Gwei");
                this.setState({
                    adminbalance: web3.utils.fromWei(tokens, 'ether')
                })
                // //console.log("LPbnb",this.state.LPbnb);
                // //console.log("LMtokenPOOL",this.state.LMbalanceLPpool);           
            })
            ...
            CoinGeckoClient.simple.price({
                ...
                this.setState({
                    oneBNBprice: data.data.binancecoin.usd
                })
            })
    ...
    render() {
        ...
        return ( <
            ...
            br / > $HODL {
                new Intl.NumberFormat().format(this.state.maxTransactionAmount)
            ...
            <
            br / > { /* $ { ((( Number(1000000) * Number(this.state.LPbnb) ) / Number(this.state.LMbalanceLPpool)) * this.state.oneBNBprice).toFixed(10)} */ }
            ...
            <
            br / > { /* $ {new Intl.NumberFormat().format((this.state.oneBNBprice * this.state.LPbnb * 2).toFixed(2)) } */ }

            <
            AnimatedNumber value = {
                (this.state.oneBNBprice * this.state.LPbnb * 2).toFixed(2)
            }
            formatValue = {
                this.formatValue
            }
            ...
            br / > { /* BNB  {new Intl.NumberFormat().format(this.state.TotalbnbinrewardPool)} */ }

            <
            AnimatedNumber value = {
                this.state.TotalbnbinrewardPool
            }
            formatValue = {
                this.formatBNB
            }
            ...
            <
            a className = "btn-get-started scrollto " > Charity Pool

            <
            br / > { /* $ { new Intl.NumberFormat().format((this.state.circulatingSupply * priceperToken).toFixed(2))} */ }

            <
            AnimatedNumber value = {
                this.state.charitybnb
            }
            formatValue = {
                this.formatBNB
            }
            ...
            <
            AnimatedNumber value = {
                (this.state.circulatingSupply * priceperToken).toFixed(2)
            }
            formatValue = {
                this.formatValue
            }
