...
export class DappHeader extends Component {
    ...
    render() {
        ...
        if (this.address) {
            ...
            connect_button = < a type = "button"
            class = "btn btn-primary get-started-btn scrollto address" > {
                this.address
            } < /a>
            logout_button = < a onClick = {
                this.logoutUser
            }
            type = "button"
            class = "btn btn-primary get-started-btn scrollto address" > Logout < /a>  
            var showlogout = true;
        } else

        {
            ...
            connect_button = < a href = "#about"
            type = "button"
            class = "btn btn-primary get-started-btn scrollto"
            data - toggle = "modal"
            data - target = "#confirmModal" > Connect < /a>
        ...
        return ( <
            ...
            <
            a href = "/"
            className = "logo mr-auto" > < img src = {
                logo
            }
            alt = ""
            ...
            aria - hidden = "true" >
            <
            div className = "modal-dialog modal-dialog-centered modal-connect"
            role = "document" >
            <
            ...
            <
            h5 color = "text"
            class = "sc-gtsrHT sc-bCwfaz itNBpW kcUtoS" > Connect to a wallet < /h5> <
            /div> <
            ...
            class = "link-effect" >
            <
            button class = "connect-list-btn connect-wallet-label"
            width = "100%"
            id = "wallet-connect-metamask"
            scale = "md" >
            <
            div color = "primary"
            class = "sc-gtsrHT bGLBCp" > Metamask < /div> <
            img class = "connect_wallet_img"
            src = {
                Metamask
            }
            /> <
            ...
            <
            div color = "primary"
            class = "sc-gtsrHT bGLBCp" > Trust Wallet < /div> <
            img class = "connect_wallet_img"
            src = {
                TrustWallet
            }
            ...
            <
            div color = "primary"
            class = "sc-gtsrHT bGLBCp" > SafePal Wallet < /div> <
            img class = "connect_wallet_img"
            src = {
                Safepal
            }
            ...
            <
            div color = "primary"
            class = "sc-gtsrHT bGLBCp" > TokenPocket Wallet < /div> <
            img class = "connect_wallet_img"
            src = {
                TP
            }
            ...
            <
            div color = "primary"
            class = "sc-gtsrHT bGLBCp" > Math Wallet < /div> <
            img class = "connect_wallet_img"
            src = {
                MW
            }
            ...
            <
            div color = "primary"
            class = "sc-gtsrHT bGLBCp" > Binance Chain Wallet < /div> <
            img class = "connect_wallet_img"
            src = {
                BCW
            }
            ...
            aria - hidden = "true" >
            <
            div className = "modal-dialog modal-dialog-centered modal-connect modal-content-confirm"
            role = "document" >
            <
            ...
            <
            p class = "confirm-content" > Any opinions, news, research, analyses, prices, or other information contained on this website is provided as general market commentary, and does not constitute investment advice.The Hodltoken.net and its affiliates will not accept liability
            for any loss or damage, including without limitation to, any loss of profit, which may arise directly or indirectly from use of or reliance on such information.All opinions expressed on this site are owned by the respective writer and should never be considered as advice in any form. < /p> <
            ...
            label > < input class = "confirm-chk"
            type = "checkbox"
            id = "chkConfirm"
            onClick = {
                this.onPrivacyAccept
            }
            /> <b className="confirm-highlight" id="spanAcceptInfo">  I understand and accept that I will trade/invest
            HODL at my own risks < /b></label >
            <
            /div> <
            div class = "col-md-12 text-center" >
            <
            a class = "btn-get-started scrollto  confirm-btn"
            id = "confirmBtn"
            onClick = {
                this.confirmPrivacy
            } > Confirm < /a> <
