...
function Guide() {
    ...
    return ( <
        ...
        div className = "row" >
        <
        div className = "col-lg-12 d-flex flex-column justify-content-center text-center pt-4 pt-lg-0 order-2 order-lg-1"
        data - aos = "fade-up"
        data - aos - delay = "200" >
        <
        ...
        <
        a href = "#about"
        className = "btn-get-started scrollto" > Create MetaMask <
        br / > Wallet <
        /a>

        <
        a href = "#about"
        className = "btn-get-started scrollto " > Buy $HOLD on <
        br / > PancakeSwap <
        /a>
        ...
        <
        a href = "#about"
        className = "btn-get-started scrollto " > Collect <
        br / > $BNB <
        /a>
        ...
        <
        div className = "col-lg-12 video-box align-self-baseline aos-init aos-animate "
        data - aos = "zoom-in"
        data - aos - delay = "100" >
        ...
        <
        p > < strong > 2. Open a wallet or
        import one, be sure to store your keyphrase safely < /strong></p >
        ...
        3. ChainID: < span > 56, or 0x38
        if 56 doesn’ t work < /span> <br / >
        ...
        <
        p className = "mt-5" > Note: if you can’ t see this popup,
        try to reload this page again and make sure your internet is good < br / >
        ...
        <
        p > < strong > Step 3: After filling out the amount and setting the Slippage Tolerance, Click on Swap - {
            '>'
        }
        Confirm Swap to buy HODL < /strong></p >
        <
        div className = "guidee_image" >
        <
        img src = {
